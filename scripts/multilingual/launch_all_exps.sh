...
# write here your code for launchign one exp, e.g. sbatch parameters 
runexp() {
    LABEL=$1
    shift
...
for lang in en ar zh fi fr de ja it ko pt ru es th; do 
    # no retrieval
...
lang=en
label=tydiqa_cmdr_noret_${lang}; runexp $label python3 bergen.py generator='command-r-35b'  dataset='tydiqa' ++experiments_folder=$exp_folder +run_name=$label
label=tydiqa_cmdr_enret_en; runexp $label python3 bergen.py generator='command-r-35b' retriever='bge-m3' reranker='bge-m3' dataset='tydiqa' ++experiments_folder=$exp_folder +run_name=$label
label=tydiqa_cmdr_allret_${lang}; runexp $label python3 main.py generator='command-r-35b' retriever='bge-m3' reranker='bge-m3' dataset='tydiqa.retrieve_all' ++experiments_folder=$exp_folder +run_name=$label
