...
| FiQA | Task 2 of [FiQA challenge](https://sites.google.com/view/fiqa/) | [Link](https://huggingface.co/datasets/LLukas22/fiqa) | StackExchange posts, *Investment* topic (2009-2017) | Corpus from [Link](https://huggingface.co/datasets/BeIR/fiqa) | No | ```multidomain/FiQA``` | LLMeval | - |
